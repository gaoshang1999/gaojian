...
class CreateTalentTable extends Migration
{
  ...
  $table->float('work_year') ->nullable(); 
  ...
  $table->float('college_grade') ->nullable(); 
  $table->float('master_grade') ->nullable(); 
  $table->float('mba_grade') ->nullable(); 
  $table->float('school_comprehensive_grade') ->nullable(); 
  ...
  $table->float('education_parameter_1') ->nullable(); 
  $table->float('education_parameter_2') ->nullable(); 
  ...
  $table->float('product_parameter_4') ->nullable(); 
  $table->float('product_parameter_5') ->nullable(); 
  $table->float('product_parameter_6') ->nullable(); 
  $table->float('product_parameter_7') ->nullable(); 
  $table->float('product_parameter_8') ->nullable(); 
  $table->float('product_parameter_9') ->nullable(); 
  $table->float('product_parameter_10') ->nullable(); 
  $table->integer('current_annual_salary_range') ->nullable(); 
  $table->float('current_pretax_annual_salary') ->nullable(); 
  $table->float('current_pretax_salary') ->nullable(); 
  $table->float('expect_pretax_annual_salary') ->nullable(); 
  $table->float('expect_pretax_salary') ->nullable(); 
  $table->float('expect_salary_increase') ->nullable(); 
  $table->float('salary_structure_parameter_1') ->nullable(); 
  $table->float('salary_structure_parameter_2') ->nullable(); 
  ...
  $table->float('job_hopping_digit') ->nullable(); 
  ...
  $table->float('corporation_parameter_4') ->nullable(); 
  $table->float('corporation_parameter_5') ->nullable(); 
  $table->float('corporation_parameter_6') ->nullable(); 
  $table->float('corporation_parameter_7') ->nullable(); 
  $table->float('corporation_parameter_8') ->nullable(); 
  $table->float('corporation_parameter_9') ->nullable(); 
  $table->float('corporation_parameter_10') ->nullable(); 
  ...
  $table->float('analysis_status_parameter_1') ->nullable(); 
  $table->float('analysis_status_parameter_2') ->nullable(); 
  $table->float('analysis_status_parameter_3') ->nullable(); 
  $table->float('analysis_status_parameter_4') ->nullable(); 
  $table->float('analysis_status_parameter_5') ->nullable(); 
  $table->float('analysis_status_parameter_6') ->nullable(); 
$table->timestamps(); 
});
    }
