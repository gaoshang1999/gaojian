...
@if(!Request::has('open')) 
 <div class="row">
                    ...
                    <div class="col-md-2 " col-sm-offset-3>                        
                               ...
                               <a class="btn btn-warning" href="{{ url('/front/match/add') }}" role="button">新增职位</a><br><br>
                         </div>
<!--                       <div class="col-md-2" col-sm-offset-3>                        -->
...
<!--                            <a class="btn btn-warning" href="#"><i class="icon_plus_alt2"></i></a> -->
                      <a href="{{ url("/front/match/view/{$v->id}") }}" class="btn btn-warning btn-sm" role="button">
                      职位详细
                      </a>
                      @if(!Request::has('open')) 
 ...
 @if(!Request::has('open')) 
                      <form action='{{ url("/front/match/delete/{$v->id}") }}' method="post"  class="pull-right">
                      ...
                      <form name="match-form" action='{{ url("/front/match/match1/{$v->id}") }}' method="get"  class="pull-right">
