...
<!-- 筛选 form-->
 ...
 <div class="row">
           ...
           <div class="col-md-2" col-sm-offset-3>
           <?php  $d2= App\Models\Demand::demandForMyTalent()->select('demand_type_label_1')->whereNotNull('demand_type_label_1')->distinct()->orderBy('demand_type_label_1') ->get();?>
                 ...
                 <tr>
                     ...
                     <td>
                      <div class="btn-group">
                            ...
                            <a class="btn btn-warning" href="{{ url("/front/myrecommend/history/{$v->id}?talent_id={$v->talent_id}") }}" target="_blank" role="button">推荐历史</a>
