...
<div class="form-group">
	<label class="col-sm-3 control-label no-padding-right" for="mobile">
		手机 </label>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="number" id="age" name="age" placeholder="年龄" min="0"
			step="1" class="col-xs-10 col-sm-5"
			value="{{ old('age', $talent  ? $talent-> age : '') }}" />
	</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea type="text/plain" id="basic_extension_info_3"
			name="basic_extension_info_3" rows="5"
			class="col-xs-10 col-sm-5 autosize-transition">{{ old('basic_extension_info_3', $talent  ? $talent-> basic_extension_info_3 : '') }}</textarea>
	</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea type="text/plain" id="basic_extension_info_4"
			name="basic_extension_info_4" rows="5"
			class="col-xs-10 col-sm-5 autosize-transition">{{ old('basic_extension_info_4', $talent  ? $talent-> basic_extension_info_4 : '') }}</textarea>
	</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea type="text/plain" id="expect_label_1" name="expect_label_1"
			rows="5" class="col-xs-10 col-sm-5 autosize-transition">{{ old('expect_label_1', $talent  ? $talent-> expect_label_1 : '') }}</textarea>
	</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea type="text/plain" id="expect_label_2" name="expect_label_2"
			rows="5" class="col-xs-10 col-sm-5 autosize-transition">{{ old('expect_label_2', $talent  ? $talent-> expect_label_2 : '') }}</textarea>
	</div>
