...
<div class="page-content"> @include('errors.list')
	<div class="row">
		<div class="col-xs-12">
		<h3 class="header smaller lighter blue"> {{ $recommend ? '编辑' : '新建' }}推荐 </h3>
				...
				<div class="tab-content">
					<div id="basic" class="tab-pane in active">
						...
						<form class="form-horizontal" role="form" method="post"
							action="{{ url('/admin/recommend/' . ($recommend ? 'edit/'.$recommend->id : 'add')) }}">
							<input type="hidden" name="_token" value="{{ csrf_token() }}">

							@include('admin.recommend.basic_form_element')
					...
					<div id="detail" class="tab-pane in ">
						...
						<form class="form-horizontal" role="form" method="post"
							...
							@include('admin.recommend.detail_form_element')
					...
					<div id="other" class="tab-pane in ">
						...
						<form class="form-horizontal" role="form" method="post"
							...
							@include('admin.recommend.other_form_element')
