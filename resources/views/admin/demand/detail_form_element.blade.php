...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" id="demand_label_3" name="demand_label_3"
			placeholder="需求标签3" class="col-xs-10 col-sm-5"
			value="{{ old('demand_label_3', $demand ? $demand-> demand_label_3 : '') }}" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" id="demand_label_4" name="demand_label_4"
			placeholder="需求标签4" class="col-xs-10 col-sm-5"
			value="{{ old('demand_label_4', $demand ? $demand-> demand_label_4 : '') }}" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" id="demand_label_5" name="demand_label_5"
			placeholder="需求标签5" class="col-xs-10 col-sm-5"
			value="{{ old('demand_label_5', $demand ? $demand-> demand_label_5 : '') }}" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" id="occupation_requirement"
			name="occupation_requirement" placeholder="行业要求"
			class="col-xs-10 col-sm-5"
			value="{{ old('occupation_requirement', $demand ? $demand-> occupation_requirement : '') }}" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" id="corporation_requirement"
			name="corporation_requirement" placeholder="公司要求"
			class="col-xs-10 col-sm-5"
			value="{{ old('corporation_requirement', $demand ? $demand-> corporation_requirement : '') }}" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" id="product_requirement" name="product_requirement"
			placeholder="产品要求" class="col-xs-10 col-sm-5"
			value="{{ old('product_requirement', $demand ? $demand-> product_requirement : '') }}" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" id="certification_requirement"
			name="certification_requirement" placeholder="认证要求"
			class="col-xs-10 col-sm-5"
			value="{{ old('certification_requirement', $demand ? $demand-> certification_requirement : '') }}" />
	</div>
</div>
