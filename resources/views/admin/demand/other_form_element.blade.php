...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea type="text/plain" id="occupation_extension_requirement_1"
			name="occupation_extension_requirement_1" rows="5"
			class="col-xs-10 col-sm-5 autosize-transition">{{ old('occupation_extension_requirement_1', $demand  ? $demand-> occupation_extension_requirement_1 : '') }}</textarea>
	</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea type="text/plain" id="corporation_extension_requirement_1"
			name="corporation_extension_requirement_1" rows="5"
			class="col-xs-10 col-sm-5 autosize-transition">{{ old('corporation_extension_requirement_1', $demand  ? $demand-> corporation_extension_requirement_1 : '') }}</textarea>
	</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea type="text/plain" id="corporation_extension_requirement_2"
			name="corporation_extension_requirement_2" rows="5"
			class="col-xs-10 col-sm-5 autosize-transition">{{ old('corporation_extension_requirement_2', $demand  ? $demand-> corporation_extension_requirement_2 : '') }}</textarea>
	</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea type="text/plain" id="product_extension_requirement_1"
			name="product_extension_requirement_1" rows="5"
			class="col-xs-10 col-sm-5 autosize-transition">{{ old('product_extension_requirement_1', $demand  ? $demand-> product_extension_requirement_1 : '') }}</textarea>
	</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea type="text/plain" id="certification_requirement_1"
			name="certification_requirement_1" rows="5"
			class="col-xs-10 col-sm-5 autosize-transition">{{ old('certification_requirement_1', $demand  ? $demand-> certification_requirement_1 : '') }}</textarea>
	</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea type="text/plain" id="tool_extension_requirement_1"
			name="tool_extension_requirement_1" rows="5"
			class="col-xs-10 col-sm-5 autosize-transition">{{ old('tool_extension_requirement_1', $demand  ? $demand-> tool_extension_requirement_1 : '') }}</textarea>
	</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea type="text/plain" id="recruit_corporation_label_1"
			name="recruit_corporation_label_1" rows="5"
			class="col-xs-10 col-sm-5 autosize-transition">{{ old('recruit_corporation_label_1', $demand  ? $demand-> recruit_corporation_label_1 : '') }}</textarea>
	</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea type="text/plain" id="recruit_corporation_label_2"
			name="recruit_corporation_label_2" rows="5"
			class="col-xs-10 col-sm-5 autosize-transition">{{ old('recruit_corporation_label_2', $demand  ? $demand-> recruit_corporation_label_2 : '') }}</textarea>
	</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea type="text/plain" id="background_label_1"
			name="background_label_1" rows="5"
			class="col-xs-10 col-sm-5 autosize-transition">{{ old('background_label_1', $demand  ? $demand-> background_label_1 : '') }}</textarea>
	</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea type="text/plain" id="background_label_2"
			name="background_label_2" rows="5"
			class="col-xs-10 col-sm-5 autosize-transition">{{ old('background_label_2', $demand  ? $demand-> background_label_2 : '') }}</textarea>
	</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea type="text/plain" id="reward_label_1" name="reward_label_1"
			rows="5" class="col-xs-10 col-sm-5 autosize-transition">{{ old('reward_label_1', $demand  ? $demand-> reward_label_1 : '') }}</textarea>
	</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea type="text/plain" id="reward_label_2" name="reward_label_2"
			rows="5" class="col-xs-10 col-sm-5 autosize-transition">{{ old('reward_label_2', $demand  ? $demand-> reward_label_2 : '') }}</textarea>
	</div>
