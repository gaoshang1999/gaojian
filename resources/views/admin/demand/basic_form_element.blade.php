...
<div class="form-group">
	...
	<div class="input-group col-sm-4">
		<input class="form-control date-picker col-xs-10 col-sm-5"
			...
			data-date-format="yyyy-mm-dd"
			value="{{ old('end_time', $demand ? $demand-> end_time : '') }}" /> <span
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" id="demand_type_label_2" name="demand_type_label_2"
			placeholder="需求类型标签2" class="col-xs-10 col-sm-5"
			value="{{ old('demand_type_label_2', $demand ? $demand-> demand_type_label_2 : '') }}" />
	</div>
</div>
...
<div class="form-group">
	<label class="col-sm-3 control-label no-padding-right" for="bonus"> 奖金
	</label>
	<div class="col-sm-9">
