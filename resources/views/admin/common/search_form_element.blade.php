...
<div id="text-filter" class="row" >
      ...
      <select class="col-sm-2" id="field1" name="field1"  tabindex="1"> 
	  ...
	  <input class="col-sm-5"  type="text" placeholder="" name="q1" value="{{ isset($q1) ? $q1 : "" }}" tabindex="2" /> 
</div>  
<div id="number-filter" class="row" >
      ...
      <select class="col-sm-2" id="field2" name="field2"  tabindex="1">
      <?php $field = isset($field2) ? $field2 : ""; ?>      
		...
		<input class="col-sm-3"  type="number" placeholder="" name="q2_start" 	step="1" value="{{ isset($q2_start) ? $q2_start : "" }}" tabindex="2" /> 
		<input class="col-sm-3"  type="number" placeholder="" name="q2_end" 	step="1" value="{{ isset($q2_end) ? $q2_end : "" }}" tabindex="2" />
</div>
<div id="date-filter" class="row" >
      ...
      <select class="col-sm-2" id="field3" name="field3"  tabindex="1"> 
